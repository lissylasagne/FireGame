...
public class Conversation2b : MonoBehaviour {
    ...
    void Update() { 
        if(message1 == false && Vector3.Distance(player.transform.position, transform.position) <= 40) {
            print("Hey! Don't get too close! I saw what you did to that other guy!");
            message1 = true;
        }
        ...
        if(end1 == false && ((message1 == true && Vector3.Distance(player.transform.position, transform.position) > 45) 
            ...
            print("That's right. You don't do that to me!");
            end1 = true;
        }
        ...
        if(message4 == false && Vector3.Distance(player.transform.position, transform.position) <= 10) {
            print("I'll admit, that guy was kind of annoying. But I'm nice! I don't deserve this!");
            message4 = true;
            end2 = true;
        } 
